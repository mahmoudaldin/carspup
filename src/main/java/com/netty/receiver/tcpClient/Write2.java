...
public class Write2 extends Thread {
	...
	public void runServer3() {
		...
		TcpClient tcpClient3 = TcpClient.create().port(9024).wiretap(true).host("localhost").port(9022)
		...
		byte[] connData = { (byte) 0x10, (byte) 0x3A, (byte) 0x00, (byte) 0x04, (byte) 0x4D, (byte) 0x51, (byte) 0x54,
				...
				(byte) 0x34, (byte) 0x35, (byte) 0x31, (byte) 0x32, (byte) 0x39, (byte) 0x31,
				(byte) 0x00, (byte) 0x07,
	...
	void runData3(Connection connection3) {
		...
		while (true) {
			...
			byte[] data = DatatypeConverter.parseHexBinary("32" + "6f" // packet len
					+ "00054243452f440a0f"
					/* payload */ + "02020800" + "9BF4732DE7120300"// Imei Value//9CF4732DE7120300 for 4
