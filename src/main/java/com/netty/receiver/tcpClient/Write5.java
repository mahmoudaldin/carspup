...
public class Write5 extends Thread {
	...
	public void runServer3() {
		...
		TcpClient tcpClient3 = TcpClient.create().port(9026).wiretap(true).host("localhost").port(9022)
		...
		byte[] connData =  DatatypeConverter.parseHexBinary("103a00044d51545404c300f0000f"
				+ "383630363635303537343631353833"
	...
	void runData3(Connection connection3) {
		...
		while (true) {
			...
			byte[] data = DatatypeConverter.parseHexBinary("32" + "6f" // packet len
					+ "00054243452f440a0f"
					/* payload */ + "02020800" + "4F450533C50E0300"// Imei Value//9CF4732DE7120300 for 4
