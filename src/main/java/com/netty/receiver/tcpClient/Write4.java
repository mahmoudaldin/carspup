...
public class Write4 extends Thread {
	...
	public void runServer3() {
		...
		TcpClient tcpClient3 = TcpClient.create().port(9025).wiretap(true).host("localhost").port(9022)
		...
		byte[] connData =  DatatypeConverter.parseHexBinary("103a00044d51545404c300f0000f"
				+ "383631323330303438373430363637"
	...
	void runData3(Connection connection3) {
		...
		while (true) {
			...
			byte[] data = DatatypeConverter.parseHexBinary("32" + "6f" // packet len
					+ "00054243452f440a0f"
					/* payload */ + "02020800" + "3B0520BF480F0300"// Imei Value//9CF4732DE7120300 for 4
